...
// This code is a modification of the source code here
// https://github.com/SinoalmondUnityPackage/IceMilkTea
...
namespace Events.Foundations
{
    ...
    public class StateMachine<TContext>
    {
        ...
        public abstract class State
        {
            ...
            /// このステートが所属するステートマシン
            /// </summary>
            protected StateMachine<TContext> StateMachine => stateMachine;
    ...
    public class ImtSynchronizationStateMachine<TContext> : StateMachine<TContext>, IDisposable
    {
        // 以下メンバ変数定義
